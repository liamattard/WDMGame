...
function click(d) {
    if (!d.children) {
        ...
        var jobs = ["Nursery Teacher", "Head Waiter" , "Boring Office Job"].indexOf(d.name);
        var apartment = ["Garage", "Small Apartment" , "Nice Apartment"].indexOf(d.name);
